...
법무 브리핑 — 데일리 요약·주제 리서치·사건 대응 등 맥락형 법무 브리핑을 생성합니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: 조사 심도 3모드(⚡◐◆)·인용 4분류 적용 — sz:contract-review의 research-depth-modes.md 준수. 법령 원문은 korean-law MCP.

...
통화 노트·녹취록 처리 — 액션 아이템 추출, 후속 이메일 초안, 내부 공유 요약을 만듭니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: 후속 메일은 등급제 적용(⚡초안 기본).
...
**UZ 컨텍스트**: UZ: RU 녹취 → KO 요약 이중 언어 처리 지원. 상세는 `references/uz-call-summary.md`.

---

## 원문 방법론 (EN, knowledge-work-plugins)

<!-- source: sales/call-summary -->
# /call-summary

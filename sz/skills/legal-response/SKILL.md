...
일반적인 법률 문의에 템플릿 기반 회신을 생성하되, 전문가 검토가 필요한 상황은 자동 에스컬레이션합니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [HARD] 법률 자문 아님 명시 — 에스컬레이션 기준(소송 예고·규제기관·형사)은 반드시 전문가 확인 권고. 회신 초안은 등급제 적용.

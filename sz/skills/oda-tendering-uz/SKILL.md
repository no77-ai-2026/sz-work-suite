...
상세는 `sz:process-manager/references/uz-procurement-zakupki.md`.
...
상세는 `sz:strategy-planner/references/uz-market-entry.md`.
...
- **민간 입찰 (비ODA)** → `sz:process-manager`
- **계약 법무** → `sz:contract-review`
- **사업화 (비ODA)** → `sz:strategy-planner`

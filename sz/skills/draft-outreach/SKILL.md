...
프로스펙트 리서치 후 개인화된 콜드 아웃리치 메시지를 초안합니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [HARD] 광고성 메시지 발송 시 정통망법 준수 — commerce-marketing-compliance-kr(미포함) 검수 권장(설치 시).
...
**UZ 컨텍스트**: UZ: 첫 접촉은 소개(타니시)를 통한 워밍 관습 — 콜드 대비 소개 요청 경로 대안 제시. 상세는 `references/uz-draft-outreach.md`.

---

## 원문 방법론 (EN, knowledge-work-plugins)

<!-- source: sales/draft-outreach -->
# Draft Outreach

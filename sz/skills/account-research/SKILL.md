...
기업·인물 영업 리서치 — 웹 검색 기반으로 실행 가능한 영업 인텔을 정리합니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [경계] 시장 규모·경쟁 구도는 sz:market-analyst, 채용 관점 기업 조사는 job-analyzer(미포함).
...
**UZ 컨텍스트**: UZ: 기업 실체 확인은 등록번호(STIR)·orginfo. 상세는 `references/uz-account-research.md`.

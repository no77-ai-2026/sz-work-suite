...
WCAG 2.1 AA 접근성 감사 — 디자인·페이지의 대비·키보드·스크린리더 이슈를 점검합니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [경계] 종합 UX 평가는 sz:ux-designer(WCAG 포함) — 이 스킬은 접근성 전용 딥다이브. 한국 웹접근성(KWCAG) 항목 대조 포함.

**도구 일반화**: 원문의 미국 SaaS 연동은 방법론으로만 계승한다 — 한국 실무에서는 연결된 커넥터·업로드 문서·사용자 제공 정보를 소스로 쓴다.

**UZ 컨텍스트**: UZ: 키릴/라틴 이중 표기 가독성·저사양 기기 대응을 점검 항목에 추가. 상세는 `references/uz-accessibility-review.md`.

---

## 원문 방법론 (EN, knowledge-work-plugins)

<!-- source: design/accessibility-review -->
# /accessibility-review

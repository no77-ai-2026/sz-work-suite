...
KPI 카드·필터·다중 차트를 갖춘 인터랙티브 HTML 대시보드를 만듭니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [책임 경계] 단일 차트·시각화는 sz:data-visualizer — 이 스킬은 다중 뷰 대시보드 조립.
...
**UZ 컨텍스트**: UZ: 다국어 라벨(KO/RU/UZ) 토글 옵션 패턴 제공. 상세는 `references/uz-build-dashboard.md`.

---

## 원문 방법론 (EN, knowledge-work-plugins)

<!-- source: data/build-dashboard -->

...
면접관용 면접 설계 — 역량 기반 질문지·평가 스코어카드·면접 플랜을 만듭니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: [책임 경계] 지원자 측 면접 준비는 interview-coach(미포함) — 이 스킬은 면접관·기업 측 전용.

**도구 일반화**: 원문의 미국 SaaS 연동은 방법론으로만 계승한다 — 한국 실무에서는 연결된 커넥터·업로드 문서·사용자 제공 정보를 소스로 쓴다.

**UZ 컨텍스트**: UZ: 이중 언어 면접(RU/UZ) 평가 항목·통역 배석 시나리오 포함. 상세는 `references/uz-interview-prep.md`.

---

## 원문 방법론 (EN, knowledge-work-plugins)

<!-- source: human-resources/interview-prep -->
# Interview Prep

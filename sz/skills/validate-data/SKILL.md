...
분석 공유 전 QA — 방법론·정확성·편향을 점검해 이해관계자 보고 전 오류를 걸러냅니다. 한국 표준 + UZ 듀얼 컨텍스트를 적용합니다.

**한국화 노트**: 산출물 등급제 ◆최종본의 데이터 검증 단계로 체인 가능.
...
- [책임 경계 보강] 본 스킬은 데이터 분석 방법론 QA 전담. 리서치 문서의 출처 등급·[미검증] 태그·반론 루프는 `sz:research-verify`가 담당한다.
